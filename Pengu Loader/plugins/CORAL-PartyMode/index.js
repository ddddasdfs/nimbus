...
(function initPartyMode() {
  ...
  const PANEL_ID = "coral-party-panel";
  const BUTTON_ID = "coral-party-button";
  const LOBBY_BUTTON_ID = "coral-party-lobby-button";
  ...
  function getCSSRules() {
    ...
    .spinner {
      ...
      border-radius: 50%;
      animation: coral-party-spin 0.8s linear infinite;
    }

    @keyframes coral-party-spin {
  ...
  function injectStyles() {
    const styleId = "coral-party-mode-styles";
        ...
        peersList.innerHTML = allPeers
          .map((peer) => {
            ...
            <div class="peer-item" data-summoner-id="${peer.summoner_id}">
              ...
              <button class="peer-remove" title="Remove" onclick="window.coralPartyRemovePeer(${peer.summoner_id})">
  ...
  window.coralPartyRemovePeer = function (summonerId) {
