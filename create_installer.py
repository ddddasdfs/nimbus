...
# -*- coding: utf-8 -*-
"""
Create Windows installer for nimbus using Inno Setup
"""
...
def create_installer():
    ...
    print("=" * 60)
    print("Creating nimbus Windows Installer")
    print("=" * 60)
    ...
    if not Path("dist/nimbus").exists():
        print("\nError: dist/nimbus directory not found!")
    ...
    icon_dst = Path("dist/nimbus/icon.ico")
