...
# -*- coding: utf-8 -*-
"""
Create Windows installer for Coral using Inno Setup
"""
...
def create_installer():
    ...
    print("=" * 60)
    print("Creating Coral Windows Installer")
    print("=" * 60)
    ...
    if not Path("dist/Coral").exists():
        print("\nError: dist/Coral directory not found!")
    ...
    icon_dst = Path("dist/Coral/icon.ico")
