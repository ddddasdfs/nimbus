...
# -*- coding: utf-8 -*-
"""
Create Windows installer for 2SDAY using Inno Setup
"""
...
def create_installer():
    ...
    print("=" * 60)
    print("Creating 2SDAY Windows Installer")
    print("=" * 60)
    ...
    if not Path("dist/2SDAY").exists():
        print("\nError: dist/2SDAY directory not found!")
    ...
    icon_dst = Path("dist/2SDAY/icon.ico")
