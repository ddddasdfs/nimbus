...
class TrayManager:
    """Manages the system tray icon for Coral"""
    ...
    def _create_menu(self) -> pystray.Menu:
        ...
        return pystray.Menu(
            pystray.MenuItem(f"Coral v{APP_VERSION}", None, enabled=False),
